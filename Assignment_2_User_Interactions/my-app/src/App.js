//Baseline (default website; no added iterations):
...
//   <title>About Me</title>
//   <link rel="stylesheet" href="style.css" />
//   <a href="https://github.com/Burden-Curse/Platform-Computing-Project" target="_blank" title="This takes you to my Github">
//     <button style={{fontSize: 25, backgroundColor: 'grey', color: 'lightblue', borderRadius: 25}}>github repo -&gt; Platform_Computing</button>
//   </a>
//   <br />
//   {/*requirement: Uses a mix of headers, paragraphs, and div's.*/}
...
//     <img src={img2} height={300} alt="This is a picture of me" title="Dad and I: BEFORE" />
//   </a>
//   <a href="https://github.com/Burden-Curse/Platform-Computing-Project" target="_blank" title="Striking resemblence between my dad and I">
//     <img src={img3} height={300} alt="This is a picture of me" title="Dad and I: AFTER" />
//   </a>    
//   <br />
//   Various photos of me and my family at different stages of life (click any photo to be directed to github repo)
...
//------------------------------------------------------------------------------------------
//Iteration #2: Add a 2nd link to Group repo and add a button!
//(Includes Iteration #1)
...
//   </a>
//   <link rel="stylesheet" href="style.css" />
//   <a href="https://github.com/Burden-Curse/Platform-Computing-Project" target="_blank" title="This takes you to our Github">
//     <button style={{fontSize: 25, backgroundColor: 'orange', color: 'darkblue', borderRadius: 25}}>Group 6 github repo -&gt; Platform-Computing-Project</button>
//   </a>
...
//------------------------------------------------------------------------------------------
//Iteration #3: Add a textbox and a button that does nothing!
//(Includes Iteration #1 and #2)
...
//   <form>
//   <label htmlFor="fname">Give us feedback!:</label>
//   <br />
//   <input type="text" id="fname" name="fname" />
//   <br />
//   <input type="submit" defaultValue="</form" />
//   </form>
